            ...
            serviceScope.launch {
                ...
                while (isActive) {
                    ...
                    try {
                        ...
                        // Limit enforcement intentionally lives only in
                        // BlockAccessibilityService. Keeping this service focused on durable usage
                        // collection prevents duplicate warning events and competing block-screen
